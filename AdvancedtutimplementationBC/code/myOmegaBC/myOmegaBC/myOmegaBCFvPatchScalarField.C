...
/*Foam::scalar Foam::myOmegaBCFvPatchScalarField::t() const
{
...
Foam::myOmegaBCFvPatchScalarField::
...
void Foam::myOmegaBCFvPatchScalarField::autoMap
(
...
void Foam::myOmegaBCFvPatchScalarField::rmap
(
...
)
{
    ...
    const myOmegaBCFvPatchScalarField& tiptf =
        refCast<const myOmegaBCFvPatchScalarField>(ptf);

    //fieldData_.rmap(tiptf.fieldData_, addr);
}


void Foam::myOmegaBCFvPatchScalarField::updateCoeffs() //this is the function youre going to do some modification
{
    if (updated())
    {
        return;
...
void Foam::myOmegaBCFvPatchScalarField::write //if you dont write, after 100s if you restarting it doesnt start
(
    Ostream& os
) const
{
